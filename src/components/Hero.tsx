  ...
  return (
    <section className="relative h-[120vh] w-full flex items-center justify-center overflow-hidden bg-background">
      ...
      >
        ...
        <SplitText text="Deepa" delay={0.5} className="font-great-vibes text-7xl md:text-8xl lg:text-[10rem] drop-shadow-[0_0_20px_rgba(225, 211, 193,0.3)] text-elegant-gradient" />
        ...
        <SplitText text="Yadev" delay={1.2} className="font-great-vibes text-7xl md:text-8xl lg:text-[10rem] drop-shadow-[0_0_20px_rgba(225, 211, 193,0.3)] text-elegant-gradient" />
      ...
      >
        ...
        >
          <ChevronDown className="text-primary w-8 h-8 opacity-90 drop-shadow-[0_0_5px_rgba(225, 211, 193,0.8)]" />
        </motion.div>
      </motion.div>
    </section>
  );
