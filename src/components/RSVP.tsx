            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                ...
                <button 
                  ...
                  className="w-full mt-12 py-5 rounded-xl bg-gradient-to-r from-primary/80 to-primary text-[#0B132B] font-playfair uppercase tracking-[0.3em] font-semibold text-sm flex items-center justify-center gap-4 hover:shadow-[0_0_30px_rgba(197, 160, 89,0.6)] transition-all duration-500 disabled:opacity-50 overflow-hidden relative group"
                >
